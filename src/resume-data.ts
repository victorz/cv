  ...
  education: [
    ...
    },
    {
      ...
      description: [
        ...
        "The majority of free-choice courses were programming courses, such as Android Programming, a slew of 3D programming/3D graphics courses, etc.",
      ],
    },
  ],
  projects: [
